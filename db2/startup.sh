...
for f in /docker-entrypoint-initdb.d/*; do
  case "$f" in
    ...
    *.sql)    echo "$0: running $f"; echo "exit" | /u01/app/oracle/product/11.2.0/xe/bin/sqlplus "norbert/oracle" @"$f"; echo ;;
    *)        echo "$0: ignoring $f" ;;
  esac
  echo
done

/u01/app/oracle/product/11.2.0/xe/bin/sqlplus "norbert/oracle" @"/tmp/exo3.sql";
